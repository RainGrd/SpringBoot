...
public class CodeGenerator {
     ...
     * 数据库连接字符
     */
    private static final String URL = "jdbc:mysql://localhost:3306/bdqn?serverTimezone=UTC";

    /**
     * 示例：private static final String PARENT_PACKAGE_NAME = "com.example.mybatisplusdemo";
     */
    private static final String PARENT_PACKAGE_NAME = "com";
     ...
     * 项目根路径
     */
    private static final String PROJECT_ROOT_PATH = System.getProperty("user.dir") + "/springboot_09_ssmp";
...
//        completeGenerator();
    ...
    protected static void simpleGenerator() {
        ...
        // XML文件的路径
        String mapperXmlPath = PROJECT_ROOT_PATH + "/src/main/resources/com/bdqn/mapper";
